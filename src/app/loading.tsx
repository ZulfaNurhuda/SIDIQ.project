 ...
 * @description File ini mendefinisikan komponen loading global untuk aplikasi dengan desain glassmorphism.
 */
...
/**
 * @function Loading
 * @description Komponen loading global dengan animasi dan desain yang konsisten dengan tema aplikasi.
 * Menampilkan spinner loading dan pesan yang menenangkan pengguna.
 * @returns {JSX.Element} Komponen loading yang dirender.
 */
export default function Loading() {
    ...
    useEffect(() => {
        ...
        const texts = ['Memuat', 'Memuat.', 'Memuat..', 'Memuat...'];
        let index = 0;
            ...
            <div className="relative z-10 text-center space-y-8">
                ...
                <div className="glass-card p-4 max-w-xs mx-auto">
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                        💡 Tip: Gunakan mode gelap untuk pengalaman yang lebih nyaman di malam hari
                    </p>
                </div>
            </div>
